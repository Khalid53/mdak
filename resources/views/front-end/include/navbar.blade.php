<nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
    ...
    <!-- Image Logo -->
    <a class="navbar-brand logo-image text-success text-decoration-none" href="{{ route('/') }}">HDGSK JV</a>
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item bg-danger">
                <a class="nav-link page-scroll text-dark" href="{{ route('job-offer') }}">Job Offer</a>
            </li>
            <li class="nav-item">
...
{{--            </li>--}}
            ...
            <li class="nav-item">
                <a class="nav-link page-scroll" href="{{ route('jcu-login') }}"><i class="fas fa-user-alt"></i> Login</a>
            </li>
